...
//     * @param interfaceNotify  $classNotify Class to send notification
     ...
     */
    public static function register(interfaceNotify $class, $debug = true, $charset = null, $fileLinkFormat = null)
    {
        self::$Notify = $class;
    ...
    public function sendPhpResponse($exception)
    {
        ...
        self::$Notify->send($this->decorate($this->getContent($exception), $this->getStylesheet($exception)));
    }
...
EOF;
    ...
    private function formatPath($path, $line)
    {
        ...
        return sprintf(' in <a title="%s line %3$d">%s line %d</a>', $path, $path, $line);
    }
